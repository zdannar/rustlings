...
pub fn divide(a: i32, b: i32) -> Result<i32, DivisionError> {
    // TODO: Seems expensive, need to be able to do this without two divisions
...
mod tests {
    ...
    fn result_with_list() {
        ...
        let x: Result<Vec<_>, _> = division_results.into_iter().collect();
    ...
    fn list_of_results() {
        let numbers = vec![27, 297, 38502, 81];
        let division_results = numbers.into_iter().map(|n| divide(n, 27));
        let x: Vec<_> = division_results.into_iter().collect();
